...
import type { BookingDetails } from "@shared/types/booking.ts";
...
const modalTitle = computed<string>(() => {
  return `${t('booking')} #${props.bookingDetails.id}`;
});
...
<style>
.booking-details-dialog .ant-modal-body {
  padding: 5px 10px 10px !important;
}

.booking-details-dialog .ant-modal-close {
  top: 15px;
}

.booking-details-dialog .ant-tabs .ant-tabs-tab .anticon {
  margin-right: 0;
}
</style>
